...
name: wireframe-spec
description: >
  Specify annotated wireframe layouts with content priority, component placement,
  behavior notes, and responsive considerations. Use when creating, revising, or
  annotating Heritage wireframes, mid-fi prototypes, or screen specs, and whenever
  the user mentions wireframes, annotations, content hierarchy, or wireframe spec.
---
...
Heritage is currently mid-fi / annotated. Stay grayscale. Prefer layout, copy, and behavior over visual polish.

Always use this skill together with [wireframe-prototyping](../wireframe-prototyping/SKILL.md):

- **wireframe-spec** — what is on the screen, in what order, required vs optional, states, and what happens on tap
- **wireframe-prototyping** — mobile-first clickable prototype, interaction flow, empty/error states, do not jump to high-fi

When changing a Heritage screen, note at least: content priority, tap behavior, empty/error if relevant, and mobile vs laptop.

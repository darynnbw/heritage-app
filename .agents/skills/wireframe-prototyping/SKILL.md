...
When working on Heritage wireframes or the mid-fi prototype, also follow `.cursor/skills/wireframe-spec/SKILL.md`. Spec the hierarchy and behavior; this skill covers the clickable prototype, fidelity, and testing.
